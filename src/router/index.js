...
const routes = [
  ...
  { path: '/objects', name: 'ObjectsMenu', component: ObjectsMenu, meta: { requiresAuth: true } },
  { path: '/objects/edit/:id', name: 'ObjectsEdit', component: ObjectsEdit, meta: { requiresAuth: true } },
  { path: '/objects/create', name: 'ObjectsCreate', component: ObjectsCreate, meta: { requiresAuth: true } },
  { path: '/profile', name: 'ProfileMenu', component: ProfileMenu, meta: { requiresAuth: true } },
